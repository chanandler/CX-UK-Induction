...
|---|---|---|
| 2026-06-18 | ✅ WelcomeView.swift + Localizable.strings | BUG-079 fixed — replaced remaining hard-coded visitor/admin strings with String(localized:) keys and added missing entries to Localizable.strings to eliminate mixed-language UI |
